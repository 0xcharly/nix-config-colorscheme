...
in
{
  flake.homeModules.fish = {
    xdg.configFile."fish/themes/${theme_name}.theme".text = with theme; ''
      # name: '${theme_name}'
      ...
      fish_color_cwd ${text_green} --italics # the current working directory in the default prompt
      ...
      fish_color_host ${text_dimmer} # the hostname in the default prompt
      fish_color_host_remote ${text_sky} # the hostname in the default prompt for remote sessions (like ssh)
